...
const Filter: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <ul
        className="hidden group-hover:block z-10 absolute right-0 mt-7 w-max rounded-lg p-1 bg-white shadow-lg text-left"
        ...
        {menu.map((item: IMenu) => (
          ...
          >
            <svg
              ...
              width="1rem"
              height="1rem"
              className={`${item.id === choice ? "opacity-100" : "opacity-0"} text-green-500`}
            >
              <path
