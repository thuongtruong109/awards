  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between">
      ...
      <ul className="grid gap-3 p-2 text-center sm:grid-cols-2 md:grid-cols-3 lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        {certificates.map((certificate: ICertificateInfo, idx: number) => (
          <li
            className="group h-80 rounded-xl bg-white p-2 transition-colors hover:bg-gray-100 hover:shadow-lg hover:dark:bg-neutral-800/30"
